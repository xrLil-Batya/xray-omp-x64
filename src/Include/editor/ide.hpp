...
public:
	typedef fastdelegate::FastDelegate<void(LPCSTR const*)>			weathers_getter_type;
	typedef fastdelegate::FastDelegate<void(u32)>					weathers_size_getter_type;
	typedef fastdelegate::FastDelegate<LPCSTR(LPCSTR const*)>	frames_getter_type;
	typedef fastdelegate::FastDelegate<LPCSTR(u32)>			frames_size_getter_type;
