...
#define __OPC_HYBRIDMODEL_H__
	...
	struct LeafTriangles
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_	uqword	GetNbTriangles()				const	{ return (Data & 15)+1;											}
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_	uqword	GetTriangleIndex()				const	{ return Data>>4;												}
		inline_	void	SetData(uqword nb, uqword index)		{ ASSERT(nb>0 && nb<=16);	nb--;	Data = (index<<4)|(nb&15);	}
	};
	...
	class OPCODE_API HybridModel : public BaseModel
	{
		 ...
		 */
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		inline_				const uqword*			GetIndices()		const	{ return mIndices;		}

		private:
							uqword					mNbLeaves;		//!< Number of leaf nodes in the model
							LeafTriangles*			mTriangles;		//!< Array of mNbLeaves leaf descriptors
							uqword					mNbPrimitives;	//!< Number of primitives in the model
							uqword*					mIndices;		//!< Array of primitive indices
