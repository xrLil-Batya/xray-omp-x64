		...
		void operator()(IClient* client)
		{
			...
			for (; I != E; ++I)
			{
				...
				else if (entity->cast_inventory_item())
				{
					...
					{
						// Åñëè ðîäèòåëüñêèé îáúåêò îòñóòñòâóåò, çíà÷èò ýòî ïðîñòî ïðåäìåò ëåæàùèé íà êàðòå.
						// Òàêèå îáúåêòû íå îáíîâëÿþòñÿ ïîñòîÿííî (ïî êðàéíåé ìåðå íå äîëæíû).
						m_updator->write_update_for(entity->ID, packet);
					}
				}
				else
