...
IC ref_sound_data::ref_sound_data() { handle = 0; feedback = 0; g_type = 0; g_object = 0; s_type = st_Effect; dwBytesTotal = 0; fTimeTotal = 0.f; }
IC ref_sound_data::ref_sound_data				( LPCSTR fName, esound_type sound_type, int	game_type )	{ handle = 0; feedback = 0; g_type = 0; g_object = 0; s_type = st_Effect; dwBytesTotal = 0; fTimeTotal = 0.f; ::Sound->_create_data			(*this,fName, sound_type, game_type);							}
