...
bool operator==(const D3D_DEPTH_STENCIL_DESC &desc1, const D3D_DEPTH_STENCIL_DESC &desc2)
{
	...
	if (desc1.DepthEnable) {
		// ñðàâíèâàåì ýòè ïîëÿ, òîëüêî åñëè âêëþ÷åí DepthEnable
		// directx ëþáèò ìåíÿòü ïîëÿ, åñëè DepthEnable íå âêëþ÷åí è ïðîâåðêà íå ñðàáàòûâàåò
	...
	if (desc1.StencilEnable) {
		// ñðàâíèâàåì ýòè ïîëÿ, òîëüêî åñëè âêëþ÷åí StencilEnable
