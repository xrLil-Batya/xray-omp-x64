...
bool CUIActorMenu::ToBag(CUICellItem* itm, bool b_use_cursor_pos)
{
	...
	{
		// Pavel: anee i?aaiao a iActorTrade, oi ii o?a aie?ai iaoiaeony a ??eacea
		// I?iaa?ea io?ia aey oiai, ?oiau ia na?anuaaeanu a?aiaoa a II,
		// i?e ia?aeeaauaaiee ec iActorTrade
		...
		// Pavel: anee i?aaiao iaoiaeeny a iActorTrade, oi ii o?a aie?ai iaoiaeony a ??eacea
		// Iiyoiio neaou yaaio ia io?ii
