...
CScriptIniFile::CScriptIniFile		(LPCSTR szFileName, bool ReadOnly, bool bLoadAtStart, bool SaveAtEnd, bool use_update) :
	inherited	(use_update ? update(szFileName) : szFileName, ReadOnly, bLoadAtStart, SaveAtEnd)
{
}
