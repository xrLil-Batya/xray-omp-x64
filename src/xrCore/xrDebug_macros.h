...
// xrSvinpodin: Добавил ASSERT как в скриптах, с поддержкой форматирования строки и неограниченным кол-вом аргументов.
...
#define VERIFY_FMT ASSERT_FMT
#define CHK_DX R_CHK
#else
#define NODEFAULT __assume(0)
#define VERIFY(...) ((void)0)
#define VERIFY_FMT(...) ((void)0)
#define CHK_DX(a) a
#endif
