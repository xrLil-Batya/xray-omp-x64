...
private:
	...
	float							SCoeff[3][4];			//eiyooeoeyiou aey nieaeia Aecua
	float							HCoeff[3][4];			//eiyooeoeyiou aey nieaeia Y?ieoa
	Fvector							IPosS, IPosH, IPosL;	//iiei?aiea aeoa?a iinea eioa?iieyoee Aecua, Y?ieoa, eeiaeiie
